const path = require('path');const GoogleFontsPlugin = require("google-fonts-webpack-plugin");const UglifyJsPlugin = require('uglifyjs-webpack-plugin')

module.exports = { entry: './src/index.js', target: 'web', devtool: 'source-map', node: {fs: 'empty' },
  output: {   filename: '2szbundle.js',    path: path.resolve(__dirname, 'docs'),    publicPath: '/',  },
